...
namespace EventsPlusLTD.Controllers
{
    public class EquipmentTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Type")] EquipmentType equipmentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Type")] EquipmentType equipmentType)
        {
