...
namespace EventsPlusLTD.Controllers
{
    public class PerformersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,FullName,ContactNumber,ContactEmail")] Performers performers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FullName,ContactNumber,ContactEmail")] Performers performers)
        {
            if (id != performers.ID)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!PerformersExists(performers.ID))
                    {
                        return NotFound();
                    }
                    else
