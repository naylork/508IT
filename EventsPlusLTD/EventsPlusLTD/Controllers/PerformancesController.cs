...
namespace EventsPlusLTD.Controllers
{
    public class PerformancesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Performance_Name,Performance_Location,Start_Time,End_Time")] Performance performance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Performance_Name,Performance_Location,Start_Time,End_Time")] Performance performance)
        {
