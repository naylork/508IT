...
namespace Events_LTD.Controllers
{
    public class PerformersController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Performers.Include(c => c.ActType);
        ...
        {
            ViewData["GenreID"] = new SelectList(_context.ActType, "GenreID", "GenreID");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("GenreID,PerformersID,FullName,ContactEmail,ContactNumber")] Performers performers)
        {
            ...
            ViewData["GenreID"] = new SelectList(_context.ActType, "GenreID", "GenreID", performers.GenreID);
            return View(performers);
        }
