...
namespace EPLTD.Controllers
{
    ...
    public class EquipmentsController : Controller
    {
        ...
        {
            ViewData["EquipmentTypeID"] = new SelectList(_context.EquipmentType, "EquipmentTypeID", "Type");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("EquipmentID,EquipmentTypeID,Equipment_Name,Availability")] Equipment equipment)
        {
            ...
            ViewData["EquipmentTypeID"] = new SelectList(_context.EquipmentType, "EquipmentTypeID", "Type", equipment.EquipmentTypeID);
            return View(equipment);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EquipmentID,EquipmentTypeID,Equipment_Name,Availability")] Equipment equipment)
        {
