...
namespace Test.Controllers
{
    public class PerformersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PerformerID,FullName,ContactNumber,ContactEmail,ActTypeID")] Performers performers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PerformerID,FullName,ContactNumber,ContactEmail,ActTypeID")] Performers performers)
        {
            if (id != performers.ActTypeID)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!PerformersExists(performers.ActTypeID))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Performers.Any(e => e.ActTypeID == id);
        }
    }
}
